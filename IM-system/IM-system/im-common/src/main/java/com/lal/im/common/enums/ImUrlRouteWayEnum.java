...
public enum ImUrlRouteWayEnum {
     ...
     * ramdom
     */
    RAMDOM(1,"com.lal.im.common.route.algorithm.random.RandomHandle"),


    /**
     * 2.轮训
     */
    LOOP(2,"com.lal.im.common.route.algorithm.loop.LoopHandle"),

    /**
     * HASH
     */
    HASH(3,"com.lal.im.common.route.algorithm.consistenthash.ConsistentHashHandle"),
    ;
