package com.lal.im.service.group.service.impl;
...
import com.lal.im.common.codec.pack.group.CreateGroupPack;
import com.lal.im.common.codec.pack.group.DestroyGroupPack;
import com.lal.im.common.codec.pack.group.UpdateGroupInfoPack;
import com.lal.im.common.config.AppConfig;
import com.lal.im.common.constant.Constants;
import com.lal.im.common.enums.GroupErrorCode;
import com.lal.im.common.enums.GroupMemberRoleEnum;
import com.lal.im.common.enums.GroupStatusEnum;
import com.lal.im.common.enums.GroupTypeEnum;
...
import com.lal.im.service.group.mapper.ImGroupMapper;
import com.lal.im.service.group.model.callback.DestroyGroupCallbackDto;
import com.lal.im.service.group.model.entity.ImGroupEntity;
import com.lal.im.service.group.model.req.*;
import com.lal.im.service.group.model.resp.GetGroupResp;
import com.lal.im.service.group.model.resp.GetJoinedGroupResp;
...
import com.lal.im.service.utils.GroupMessageProducer;
...
//        }
        ...
        if (org.apache.commons.lang3.StringUtils.isEmpty(req.getGroupId())) {
            req.setGroupId(UUID.randomUUID().toString().replace("-", ""));
        } else {
            query.eq("group_id", req.getGroupId());
            query.eq("app_id", req.getAppId());
        ...
        if (req.getGroupType() == GroupTypeEnum.PUBLIC.getCode() && org.apache.commons.lang3.StringUtils.isBlank(req.getOwnerId())) {
