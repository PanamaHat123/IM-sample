package com.lal.im.service.friendship.mapper;

import com.baomidou.mybatisplus.core.mapper.BaseMapper;
import com.lal.im.service.friendship.model.entity.ImFriendShipEntity;
import com.lal.im.service.friendship.model.req.CheckFriendShipReq;
...
public interface ImFriendShipMapper extends BaseMapper<ImFriendShipEntity> {
    ...
    @Select("<script>"+
            ...
            "</foreach>" +
            " and app_id = #{appId} " +
            "</script>")    public List<CheckFriendShipResp> checkFriendShip(CheckFriendShipReq req);
