...
export default class WebToolkit {
  ...
  // TODO: Get wx applet device information
  ...
  // TODO: Get ReactNative device information
  ...
  // TODO: Get UniApp device information
  ...
  // Dynamically add a script to the head tag
  ...
  // Get current ip information (fetch mode)
  ...
  //Obtain the current ip information (dynamically inserted script script)
  ...
  public static getIpInfo(callback) {
    /*IFTRUE_WXAPP*/
    // In the case of small programs, the pv.sohu.com domain name needs to be whitelisted
